...
(function(){
    ...
    function miniMapInit() {
        ...
        if ($('#mini-map-wrapper').length === 0){
            var wrapAll =  $('<div>').addClass("wrap-minimap mhscale").appendTo(document.body);

            var wrapper = $('<div>').attr('id', 'mini-map-wrapper').css({position: 'fixed',zIndex: '4',bottom: 10,right: 10,width: 160,height: 160});
            ...
            var setka = $("<div id='setka' style='width:160px;height:160px;position:fixed;bottom:10px;right:10px;'><table width='100%' height='100%'><tr><td>A1</td><td>A2</td><td>A3</td><td>A4</td><td>A5</td></tr><tr><td>B1</td><td>B2</td><td>B3</td><td>B4</td><td>B5</td></tr><tr><td>C1</td><td>C2</td><td>C3</td><td>C4</td><td>C5</td></tr><tr><td>D1</td><td>D2</td><td>D3</td><td>D4</td><td>D5</td></tr><tr><td>E1</td><td>E2</td><td>E3</td><td>E4</td><td>E5</td></tr></table></div>");
			setka.appendTo(wrapAll);
            ...
            wrapper.append(mini_map).appendTo(wrapAll);
